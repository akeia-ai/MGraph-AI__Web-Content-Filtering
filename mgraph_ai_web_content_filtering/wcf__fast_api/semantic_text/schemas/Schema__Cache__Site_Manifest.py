...
class Schema__Cache__Site_Manifest(Type_Safe):                                    # Metadata for a cached website domain
    ...
    total_unique_hashes  : int                = 0                                 # Total unique text hashes seen
    pages_processed      : int                = 0                                 # Number of pages processed
    last_updated         : Timestamp_Now                                          # Auto-generates timestamp
    common_elements_hash : Safe_Str__Hash      = None                             # Points to common.json cache entry
    bloom_filter_hash    : Safe_Str__Hash      = None                             # Points to bloom filter cache entry
    pages_index_hash     : Safe_Str__Hash      = None                             # Points to pages index cache entry
